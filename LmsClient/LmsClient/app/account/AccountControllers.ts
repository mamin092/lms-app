module App {
    ...
    export 
        ...
        constructor(state: angular.ui.IStateService, scope: angular.IScope, rootScope: angular.IRootScopeService, localStorageService: LocalStorageService,
            account: AccountService, web: WebService) {
